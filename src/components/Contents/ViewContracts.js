...
const ViewContracts = () => {
  ...
  const columns = [
    ...
    {
      dataField: "tenderingMode.label",
      text: "Mode of Tendering",
      headerAlign: "center",
      headerStyle: { minWidth: "100px", backgroundColor: "#A7C7E7" },
      sort: true,
      searchable: true,
    ...
    {
      dataField: "completionPeriod",
      text: "Completion Period",
      headerAlign: "center",
      headerStyle: { minWidth: "100px", backgroundColor: "#A7C7E7" },
      sort: true,
      searchable: false,
    },
    {
      ...
      text: "Details of Party / Contractor",
      headerAlign: "center",
      headerStyle: { minWidth: "100px", backgroundColor: "#A7C7E7" },
      sort: true,
      searchable: true,
    ...
    {
      dataField: "vendorCodeOrPO",
      text: "Vendor Code / SAP PO",
      headerAlign: "center",
      headerStyle: { minWidth: "100px", backgroundColor: "#A7C7E7" },
      sort: true,
      searchable: true,
